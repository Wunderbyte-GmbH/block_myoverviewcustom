...
namespace block_myoverviewcustom;
...
final class myoverview_test extends \advanced_testcase {
    ...
    public function test_get_block_config_for_external(): void {
        ...
        set_config('displaygroupingcustomfield', 1, 'block_myoverviewcustom');
        set_config('customfiltergrouping', $field->get('shortname'), 'block_myoverviewcustom');
        ...
        foreach ($blocks as $region => $regionblocks) {
            ...
            foreach ($regioninstances as $ri) {
                // Look for myoverviewcustom block only.
                if ($ri->instance->blockname == 'myoverviewcustom') {
        ...
        $this->assertEquals(get_config('block_myoverviewcustom', 'version'), $configs->plugin->version);
        // Test custom fields.
