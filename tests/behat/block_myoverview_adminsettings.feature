@block @block_myoverviewcustom @javascript
Feature: The my overview block allows admins to easily configure the students' course list
  ...
  Scenario: Enable 'All (including removed from view)' course filter option
    ...
    Then "All (including removed from view)" "list_item" should exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'All (including removed from view)' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "All (including removed from view)" "list_item" should not exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'All' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "[data-value='all']" "css_element" should exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'All' course filter option
    ...
    Then "[data-value='all']" "css_element" should not exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'In progress' course filter option
    ...
    Then "In progress" "list_item" should exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'In progress' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "In progress" "list_item" should not exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Future' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Future" "list_item" should exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Future' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Future" "list_item" should not exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Past' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Past" "list_item" should exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Past' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Past" "list_item" should not exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Starred' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Starred" "list_item" should exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Starred' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Starred" "list_item" should not exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Removed courses' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Removed from view" "list_item" should exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Removed courses' course filter option
    ...
    Then I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
    Then "Removed from view" "list_item" should not exist in the ".block_myoverviewcustom .dropdown-menu" "css_element"
  ...
  Scenario: Disable all course filter options
    ...
    Then "button#groupingdropdown" "css_element" should not exist in the ".block_myoverviewcustom" "css_element"
