...
Feature: My overview block pagination
  ...
  Scenario: The pagination controls should be hidden if I am not enrolled in any courses
    ...
    And ".block_myoverviewcustom .dropdown-menu.show" "css_element" should not be visible
    And ".block_myoverviewcustom [data-control='next']" "css_element" should not be visible
    And ".block_myoverviewcustom [data-control='previous']" "css_element" should not be visible
    And I log out
  ...
  Scenario: The default pagination should be 12 courses
    ...
    When I am on the "My courses" page logged in as "student1"
    Then I should see "12" in the ".block_myoverviewcustom [data-action='limit-toggle']" "css_element"
    And I log out
  ...
  Scenario: I should only see pagination limit options less than total number of enrolled courses
    ...
    And ".block_myoverviewcustom [data-control='next']" "css_element" should be visible
    And ".block_myoverviewcustom [data-control='previous']" "css_element" should be visible
    But I should not see "24" in the ".block_myoverviewcustom .dropdown-menu.show" "css_element"
    And I log out
  ...
  Scenario: Previous page button should be disabled when on the first page of courses
    Given the following "course enrolments" exist:
      ...
      | student1 | C13 | student |
    When I am on the "My courses" page logged in as "student1"
    Then the "class" attribute of ".block_myoverviewcustom [data-control='previous']" "css_element" should contain "disabled"
    And I log out
  ...
  Scenario: Next page button should be disabled when on the last page of courses
    Given the following "course enrolments" exist:
      ...
      | student1 | C13 | student |
    When I am on the "My courses" page logged in as "student1"
    And I wait until ".block_myoverviewcustom [data-control='next']" "css_element" exists
    And I click on "[data-control='next']" "css_element" in the "Course overview" "block"
    Then the "class" attribute of ".block_myoverviewcustom [data-control='next']" "css_element" should contain "disabled"
    And I log out
  ...
  Scenario: Next and previous page buttons should both be enabled when not on last or first page of courses
    ...
    And I wait until ".block_myoverviewcustom [data-control='next']" "css_element" exists
    And I click on "[data-control='next']" "css_element" in the "Course overview" "block"
    Then the "class" attribute of ".block_myoverviewcustom [data-control='next']" "css_element" should not contain "disabled"
    And the "class" attribute of ".block_myoverviewcustom [data-control='previous']" "css_element" should not contain "disabled"
