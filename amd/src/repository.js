 ...
 *
 * @module block_myoverviewcustom/repository
...
export const getEnrolledCoursesByTimeline = args => {
    const request = {
        methodname: 'block_myoverviewcustom_get_enrolled_courses_by_timeline_classification',
        args: args
    };
 ...
 * @return {promise} Resolved with an array of courses
 */
export const getEnrolledCoursesWithCustomfields = args => {
    const request = {
        methodname: 'block_myoverviewcustom_get_enrolled_courses_by_timeline_classification',
        args: args
    };
