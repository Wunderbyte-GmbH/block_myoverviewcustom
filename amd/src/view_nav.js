...
const updatePreferences = (filter, value) => {
    let type = null;
    if (filter === 'display') {
        type = 'block_myoverviewcustom_user_view_preference';
    } else if (filter === 'sort') {
        type = 'block_myoverviewcustom_user_sort_preference';
    } else if (filter === 'customfieldvalue') {
        type = 'block_myoverviewcustom_user_grouping_customfieldvalue_preference';
    } else {
 ...
 *
 * @param {object} root The root element for the myoverviewcustom block
 */
